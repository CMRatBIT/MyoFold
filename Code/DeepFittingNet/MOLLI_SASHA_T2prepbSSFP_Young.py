...
def TestingInvivo( loadDataPath,TxDispMax, worksheet , xlsxRowrow,xlsxCol , seqTag = 'MOLLI53',LLCorrection=False, Para='T1'):
    try:
        ...
        print(e)
    return stRow
workbook = xlsxwriter.Workbook( os.path.normpath(cwdpath.parent.parent)+'//Results//Young//'+'MOLLI_SASHA_T2prepbSSFP.xlsx')
worksheet = workbook.add_worksheet()

xlsxRow = 0
xlsxCol = 0

xlsxRow = TestingInvivo(os.path.normpath(cwdpath.parent.parent)+'//data//Young//MOLLI.mat',2500,worksheet, xlsxRow,xlsxCol,'MOLLI',False,'T1')
xlsxRow = TestingInvivo(os.path.normpath(cwdpath.parent.parent)+'//data//Young//SASHA.mat',2500,worksheet, xlsxRow,xlsxCol,'SASHA',False, 'T1')
xlsxRow = TestingInvivo(os.path.normpath(cwdpath.parent.parent)+'//data//Young//T2prepbSSFP.mat',100,worksheet, xlsxRow,xlsxCol,'T2prepbSSFP',False, 'T2')
